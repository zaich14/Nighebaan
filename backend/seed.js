...
const seedDatabase = async () => {
  try {
    ...
    const users = await User.create([
      ...
      {
        name: "Rabia Akhtar",
        email: "rabia.akhtar@example.com",
        password: "patient123",
        role: "user",
      },
      {
    ...
    console.log("✓ Created 16 test users");
    ...
    console.log("  Patient: nadia.hassan@example.com / patient123");
    console.log("  Patient: tariq.mahmood@example.com / patient123");
    console.log("  Patient: amna.javed@example.com / patient123");
    console.log("  Patient: abdul.rehman@example.com / patient123");
    console.log("  Patient: rabia.akhtar@example.com / patient123");
    console.log("  Patient: ali.raza@example.com / patient123");
    console.log("  Patient: zainab.mirza@example.com / patient123");
