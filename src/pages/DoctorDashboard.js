        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.6fr]">
          ...
          <div className="space-y-5">
            ...
            <button
              ...
              className="w-full rounded-3xl bg-cyan-600 p-8 text-left shadow-lg shadow-cyan-100 transition hover:bg-cyan-700 active:scale-[0.99]"
            >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <button
                ...
                className="rounded-3xl bg-yellow-600 p-5 text-left shadow-sm shadow-cyan-100 transition hover:bg-cyan-700"
              >
                <span className="text-2xl">💊</span>
                <p className="mt-3 text-base font-semibold text-white">Write Prescription</p>
                <p className="mt-1 text-xs text-white-200">Issue medicines to a patient</p>
              </button>
              <button
                onClick={() => navigate("/patients")}
                className="rounded-3xl bg-rose-600 p-5 text-left shadow-sm shadow-cyan-100 transition hover:bg-cyan-700"
              >
                <span className="text-2xl">👥</span>
                <p className="mt-3 text-base font-semibold text-white">View Patients</p>
                <p className="mt-1 text-xs text-white-200">Browse records and health history</p>
              </button>
            </div>
          </div>
