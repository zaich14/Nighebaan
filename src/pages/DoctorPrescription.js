                    ...
                    <div key={rx.id} className="rounded-2xl border border-slate-200 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-4 min-w-0">
                          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-cyan-100 text-sm font-bold text-cyan-700">
                            Rx
                          </div>
                      ...
                      {isOpen && (
                        <div className="border-t border-slate-100 px-5 py-5 bg-white space-y-4">
                          ...
                          {/* Medicines */}
                          <div>
                            <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-cyan-500">Prescribed Medicines</p>
                            <div className="space-y-2">
                              {rx.medicines?.map((m, i) => (
                                <div key={i} className="flex flex-wrap items-center gap-2 rounded-2xl bg-cyan-50 border border-cyan-100 px-4 py-3">
                                  <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-cyan-200 text-xs font-bold text-cyan-700">
                                    {i + 1}
                                  </span>
                                  <span className="font-semibold text-sm text-cyan-900">{m.name}</span>
                                  <span className="rounded-full bg-cyan-100 px-2.5 py-0.5 text-xs font-semibold text-cyan-700">{m.dosage}</span>
