...
const FALLBACK_PATIENTS = [
  ...
  { _id: "mock-user-7",  name: "Sara Qureshi" },
  { _id: "mock-user-8",  name: "Ali Raza" },
  { _id: "mock-user-9",  name: "Zainab Mirza" },
  { _id: "mock-user-10", name: "Rabia Akhtar" },
];
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input name="followUpDate" type="date" value={form.followUpDate} onChange={handleChange}
                  className="mt-2 w-64 rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100" />
              </div>

              <button onClick={handleSubmit} disabled={submitting}
                className="w-full rounded-2xl bg-cyan-600 py-3.5 text-sm font-semibold text-white transition hover:bg-cyan-700 disabled:opacity-50">
                    ...
                    <div key={r.id} className="rounded-2xl border border-slate-200 overflow-hidden">
                      ...
                      >
                        <div className="flex items-center gap-4 min-w-0">
                          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-cyan-100 text-sm font-bold text-cyan-700">
                        ...
                        <div className="flex shrink-0 items-center gap-3">
                          <span className="rounded-full bg-cyan-50 px-3 py-1 text-xs font-semibold text-cyan-700 hidden sm:block">
                      ...
                      {isOpen && (
                        <div className="border-t border-slate-100 px-5 py-5 bg-white space-y-4">
                          ...
                          <div className="rounded-2xl bg-cyan-50 px-4 py-3">
                            <p className="text-xs font-semibold text-cyan-500 uppercase tracking-wide">Diagnosis</p>
                            <p className="mt-1 text-sm text-cyan-900">{r.diagnosis}</p>
                          </div>
                          {r.findings && (
                            <div className="rounded-2xl bg-slate-50 px-4 py-3">
