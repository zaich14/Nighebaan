      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="bg-white rounded-3xl shadow-xl p-10">
          <div className="mb-8 text-center">
            <img src="/logo.jpeg" alt="Nigehbaan Logo" className="mx-auto h-16 w-16 rounded-full object-cover" />
            <h1 className="mt-6 text-2xl font-semibold text-slate-900">Log In</h1>
                        <h1 className="mt-6 text-3xl font-semibold text-cyan-800">Nighebaan</h1>

            <p className="mt-3 text-cyan-700">Access health monitoring and alerts for your care network.</p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-100"
              />
            </div>
            <div>
            ...
            <button
              onClick={handleLogin}
              disabled={loading}
              className="mt-4 w-full rounded-2xl bg-cyan-600 px-6 py-3 text-white transition hover:bg-cyan-800 disabled:cursor-not-allowed disabled:bg-cyan-300"
            >
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            Don't have an account? <Link to="/signup" className="font-semibold text-cyan-600 hover:text-cyan-800">Register</Link>
          </p>
          <p className="mt-2 text-center text-sm text-slate-500">
            <Link to="/forgot-password" className="font-semibold text-cyan-600 hover:text-cyan-800">Forgot Password?</Link>
          </p>
        </div>
