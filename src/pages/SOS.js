        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-3xl bg-white shadow-2xl ring-1 ring-slate-200">
            ...
            <div className="px-8 py-6 space-y-4">
              ...
              <div className="flex gap-4 rounded-2xl bg-slate-50 p-4">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-cyan-100 text-cyan-600 text-lg">📞</div>
                <div>
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <div className="flex gap-3 items-start">
              <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-cyan-100 text-lg font-bold text-cyan-700">
        ...
        <div className="mt-5 grid gap-5 lg:grid-cols-2">
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            ...
            <button
              ...
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-2xl bg-cyan-600 py-3 text-sm font-semibold text-white transition hover:bg-cyan-700 disabled:opacity-50"
            >
              {reportLoading
